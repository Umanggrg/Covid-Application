...
public class affected extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_affectedones);
    ...
    private void fetchData() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET,url, response -> {
            ...
            try {
                ...
                pieChart.addPieSlice(new PieModel("Deaths",Integer.parseInt(tvTotalDeaths.getText().toString()), Color.parseColor("#FF5722")));
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                simpleArcLoader.setVisibility(View.GONE);
                scrollView.setVisibility(View.VISIBLE);
                Toast.makeText(affected.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
